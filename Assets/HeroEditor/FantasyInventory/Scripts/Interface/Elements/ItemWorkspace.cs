...
namespace Assets.HeroEditor.FantasyInventory.Scripts.Interface.Elements
{
    ...
    public abstract class ItemWorkspace : MonoBehaviour
    {
        ...
        public const string CurrencyId = "FantasyHeroes.Basic.Supplies.Gold";
        ...
        {
            itemCollection.GeneratedItems = new List<ItemParams> { new ItemParams { Id = CurrencyId, Type = ItemType.Currency, Path = "Assets/HeroEditor/FantasyHeroes/Icons/WithoutBackground/Equipment/Supplies/Basic/Currency/Gold.png" } };
